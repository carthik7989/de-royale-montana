        ...
        <section className="flex flex-col gap-16 fp bg-primary text-secondary font-light">
            ...
            <div className="flex flex-col gap-9">
                ...
                <div className="flex flex-col md:flex-row gap-10 xl:gap-29">
                    ...
                    <div className="w-full md:w-[50%] lg:w-[40%] h-[223px] md:h-auto  bg-[url('/images/fine-dining.png')] bg-cover bg-center "></div>
          ...
          <Image className="w-[910px] h-[370px] 2xl:h-[558px] object-cover object-center" src="/images/fine-dining.png" alt="" width={910} height={558} />
            </div>
            {/* End of Row 2 */}
        </section>
    );
