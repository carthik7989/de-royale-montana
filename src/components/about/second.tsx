    ...
    return(
        <section className="flex flex-col items-center gap-16 p-16 font-mona ">
            ...
            <div className="lg:max-w-5xl flex flex-col items-center justify-center gap-4">
                <h6 className="text-accent uppercase  font-semibold">About us</h6>
                <QuoteIcon svgColor={svgColor} className="self-start ml-20" />
                <h4 className="mt-5  text-accent text-center  italic font-light">Luxury is not a thing, it&apos;s a feeling — and we make sure you feel it in every moment.</h4>
            ...
            <div className="lg:max-w-[90%] flex gap-16 ">
                <p className="w-[40%] flex flex-col gap-8  text-justify ">
