        ...
        <div className="flex flex-col items-center gap-16 fp ">
          ...
          <span className="w-full sm:w-[400px] h-1 bg-accent block"></span>
            ...
            <div className="flex flex-col items-center gap-9 font-mona">
                <h4 className="f-base sm:f-md text-text font-light italic">“ Hospitality begins with heart. ” </h4>
                <p className="f-sm mlg:f-base lg:f-sm 2xl:f-base lg:max-w-4xl  font-light text-center">At De Royale Montana, our team is not just trained — they are cultivated. Every member embodies the spirit of refined hospitality — warm, poised, and always present. Whether it’s a thoughtful gesture or an unspoken need met, our people are the soul of our promise.</p>
            </div>
            {/* End of Row 2 */}
