        ...
        <div className="flex flex-col md:flex-row divide-x divide-accent">
          ...
          <div className="w-full flex flex-col mlg:flex-row  md:w-1/2 fp justify-between">
            ...
            <div className="flex flex-col gap-y-6">
              ...
              <nav className="flex flex-col gap-y-4  uppercase font-mona font-semibold">
            ...
            {/* Rooms */}
            <div className="flex flex-col gap-y-6">
              <div className="border-l-4 border-accent pl-4 nav text-accent uppercase font-mona font-semibold">Rooms</div>
              <nav className="flex flex-col gap-y-4  uppercase font-mona font-semibold">
              ...
              <div className="flex flex-col gap-y-8 nav">
          ...
          <div className="flex flex-col gap-y-8">
            {/* Newsletter */}
            <div className="flex flex-col gap-y-4 nav">
            <div className=" uppercase font-mona font-semibold text-accent">Sign Up For Alerts, News & insights</div>
            <input type="text" placeholder="Email" className="w-full pl-4 pb-2 bg-transparent border-b-[1.5px] border-secondary text-secondary  placeholder:text-secondary/50 placeholder:nav placeholder:uppercase placeholder:font-mona placeholder:font-semibold" />
